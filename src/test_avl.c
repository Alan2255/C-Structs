...
struct asciinode_struct
{
  ...
  //-1=I am left, 0=I am tree, 1=right   
  int parent_dir;   
...
asciinode * build_ascii_tree_recursive(ATree  t) 
{
  asciinode * node;
...
asciinode * build_ascii_tree(ATree  t) 
{
  asciinode *node;
  if (t == NULL) return NULL;
...
//prints ascii tree for given ATree structure
void print_ascii_tree(ATree  t) 
{
  asciinode *proot;
  int xmin, i;
  if (t == NULL) return;
...
int main() {
  ...
  AVL tree = avl_create(copy_int, destroy_int, compare_int, visit_int);
